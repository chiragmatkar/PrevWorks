...
def contactTracing():
    ...
    vaccine =request.form.get('diagnosis_date_input') or None
    booster =request.form.get('booster') or None
    booster_date= request.form.get('diagnosis_date_input') or None
    ...
    location1_name = request.form['location1_name'] or None
    ...
    location2_name = request.form['location2_name'] or None
    ...
    location3_name = request.form['location3_name'] or None
    ...
    location4_name = request.form['location4_name'] or None
    ...
    location5_name = request.form['location5_name'] or None
    ...
    if request.method == 'POST':
        ...
        if error is None:
            try:
                ...
                mycursor = db.cursor()
                query = """
                INSERT INTO contacttracing 
                     (userId , test_type, diagnosis_date, vaccine , vaccine_date, booster, booster_date, 
                     ...
                     %s, %s, %s, %s, %s, 
                     %s)",
                    (int(session['user_id']), vaccine_type, diagnosis_timestamp , vaccine , vaccine_timestamp ,                        
                        contact1,contact1_email,contact1_rel,contact1_phone,contact1_timestamp ,
                        contact2,contact2_email,contact2_rel,contact2_phone,contact2_timestamp ,
                        contact3,contact1_email,contact3_rel,contact3_phone,contact3_timestamp ,
                        contact4,contact4_email,contact4_rel,contact4_phone,contact4_timestamp ,
                        contact5,contact5_email,contact5_rel,contact5_phone,contact5_timestamp ,
                        location1 , location1_email , location1_add1 ,location1_add2, location1_date ,
                        location2 , location2_email , location2_add1 ,location2_add2 , location2_date ,
                        location3 , location3_email , location3_add1 ,location3_add2 , location3_date ,
                        location4 , location4_email , location4_add1 ,location4_add2 , location4_date ,
